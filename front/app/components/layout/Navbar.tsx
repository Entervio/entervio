            ...
            >
                <div className="border-t border-border bg-linear-to-b from-background/95 to-background/90 backdrop-blur-lg">
                    <div className="container mx-auto px-6 py-6 flex flex-col gap-1">
                        ...
                        {user ? (
                            <div className={`flex flex-col gap-1 pt-4 mt-2 border-t border-border transform ${
                                isMobileMenuOpen 
                                    ? 'translate-x-0 opacity-100' 
                                    : '-translate-x-4 opacity-0'
                            ...
                            <div className={`flex flex-col gap-2 pt-4 mt-2 border-t border-border transform ${
                                isMobileMenuOpen 
                                    ? 'translate-x-0 opacity-100' 
                                    : '-translate-x-4 opacity-0'
                            } transition-all duration-300 delay-300`}>
